...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'constructora.context_processors.site_settings',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'constructora_db'),
...
# Configuración para subdominios (admin.constructora.com)
SESSION_COOKIE_DOMAIN = os.getenv('SESSION_COOKIE_DOMAIN', None)
CSRF_COOKIE_DOMAIN = os.getenv('CSRF_COOKIE_DOMAIN', None)
SESSION_COOKIE_SAMESITE = 'Lax'
CSRF_COOKIE_SAMESITE = 'Lax'

# URLs de login/logout para backoffice
